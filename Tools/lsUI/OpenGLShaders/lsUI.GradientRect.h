...
LS_COMPILE_TIME_FILE_REL_PATH(__ls_ui_DefGradientRectVertSrc, __FILE__, "Debug\\DefGradientRect.vert");
LS_COMPILE_TIME_FILE_REL_PATH(__ls_ui_DefGradientRectFragSrc, __FILE__, "Debug\\DefGradientRect.frag");

#else
const char *__ls_ui_DefGradientRectVertSrc = R"LONGLONG(
#version 330 core
